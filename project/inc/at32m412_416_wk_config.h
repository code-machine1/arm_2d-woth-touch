...
#define LCD_DC_PIN    GPIO_PINS_13
#define LCD_DC_GPIO_PORT    GPIOC
#define LCD_RES_PIN    GPIO_PINS_9
#define LCD_RES_GPIO_PORT    GPIOF
#define LCD_BL_PIN    GPIO_PINS_10
#define LCD_BL_GPIO_PORT    GPIOF
#define T_IRQ_PIN    GPIO_PINS_4
#define T_IRQ_GPIO_PORT    GPIOA
#define T_DO_PIN    GPIO_PINS_5
#define T_DO_GPIO_PORT    GPIOA
#define T_DIN_PIN    GPIO_PINS_6
#define T_DIN_GPIO_PORT    GPIOA
#define T_CS_PIN    GPIO_PINS_7
#define T_CS_GPIO_PORT    GPIOA
#define T_CLK_PIN    GPIO_PINS_0
