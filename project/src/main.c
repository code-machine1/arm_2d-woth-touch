...
void touch_task(void)
{
	...
	LCD_DrawLine(0,120,320,120,RED);
	LCD_DrawLine(160,0,160,240,RED);
	
	LCD_ShowString(161,121,"X:",BLACK,WHITE,16,0);
	LCD_ShowString(161,137,"Y:",BLACK,WHITE,16,0);
	LCD_ShowIntNum(177,121,xpt2046_touch.x,3,BLACK,WHITE,16);
	LCD_ShowIntNum(177,137,   xpt2046_touch.y,3,BLACK,WHITE,16);
	
	LCD_ShowString(295,0,"RST",BLACK,WHITE,16,0);
	
	LCD_DrawPoint(xpt2046_touch.y,xpt2046_touch.x,RED);

	if(xpt2046_touch.x <= 10 && xpt2046_touch.y>= 300)
	{
	    LCD_Clear(GREEN);
		xpt2046_touch.x = 0;
		xpt2046_touch.y = 0;
...
{
LCD_ShowPicture(x,y,width,height,bitmap);
}
/* add user code end 4 */
